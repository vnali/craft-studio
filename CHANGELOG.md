...
> {tip} The studio plugin has a [starter project](https://github.com/vnali/craft-studio-starter/tree/5.x) now. Please setup a sample project which contains required fields and check how the plugin works.
