...
- Person group attribute is created based on level(1) of podcastTaxonomy entries field and role attribute is created based on level(2) ([#24](https://github.com/vnali/craft-studio/discussions/24)).
