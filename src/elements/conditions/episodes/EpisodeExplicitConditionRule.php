...
class EpisodeExplicitConditionRule extends BaseLightswitchConditionRule implements ElementConditionRuleInterface
{
    /**
     * @inheritdoc
     */
    ...
    {
        return Craft::t('studio', 'Episode Is Explicit');
    }
